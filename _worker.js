...
<body>
    <main>
        <center>
            <h2 class="brand">VLESS Noir7R</h2>
            <br>
        </center>
        <pre>
            <b>
...
» PATH        : /vless-ws
        ...
        <div style="text-align: center;">
            ==================================
            <button class="button2" onclick='copyToClipboard("${vlessTlsFormatted}")'><i class="fa fa-clipboard"></i> Copy TLS 443</button>
            <button class="button2" onclick='copyToClipboard("${vlessNtlsFormatted}")'><i class="fa fa-clipboard"></i> Copy NTLS 80 </button>
            ==================================
            <button class="button2" id="clock"></button>
            ==================================
        </div>
    </main>
    <script>
